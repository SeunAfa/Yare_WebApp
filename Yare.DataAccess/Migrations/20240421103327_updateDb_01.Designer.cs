...
namespace Yare.DataAccess.Migrations
{
    ...
    [Migration("20240421103327_updateDb_01")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Yare.Models.Accessory", b =>
                {
                    ...
                    b.Property<int?>("Product_CollectionId")
                        .HasColumnType("int")
                        .HasColumnName("Accessory_Product_CollectionId");
            ...
            modelBuilder.Entity("Yare.Models.Watch", b =>
                {
                    ...
                    b.Property<int?>("Product_CollectionId")
                        .HasColumnType("int")
                        .HasColumnName("Watch_Product_CollectionId");
            ...
            modelBuilder.Entity("Yare.Models.Product_Collection", b =>
                {
                    b.HasOne("Yare.Models.Accessory", null)
                        .WithMany("Product_CollectionsList")
                    ...
                    b.HasOne("Yare.Models.Jewellery", null)
                        .WithMany("Product_CollectionsList")
                    ...
                    b.HasOne("Yare.Models.Watch", null)
                        .WithMany("Product_CollectionsList")
                        .HasForeignKey("WatchId");
            ...
            modelBuilder.Entity("Yare.Models.Accessory", b =>
                {
                    b.Navigation("Product_CollectionsList");
                });
