...
namespace Yare_WebApplication.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            {
                _roleManager.CreateAsync(new IdentityRole(SD.Role_MasterAdmin)).GetAwaiter().GetResult();
